...
def main():
    ...
    option1X = 150
    option1Y = 175
    option1Text = font.render("Press [1]", True, (255, 255, 255))
    option2X = 550
    option2Y = 175
    option2Text = font.render("Press [2]", True, (255, 255, 255))
    option3X = 150
    option3Y = 400
    option3Text = font.render("Press [3]", True, (255, 255, 255))
    option4X = 550
    option4Y = 400
    option4Text = font.render("Press [4]", True, (255, 255, 255))
    ...
    while True:
        ...
        if onTitleScreen:
            ...
            screen.blit(option1Text, (option1X - 100, option1Y))
            screen.blit(body2, (option2X, option2Y))
            screen.blit(option2Text, (option2X - 100, option2Y))
            screen.blit(body3, (option3X, option3Y))
            screen.blit(option3Text, (option3X - 100, option3Y))
            screen.blit(body4, (option4X, option4Y))
            screen.blit(option4Text, (option4X - 100, option4Y))
            ...
            backgroundDraw()
            prompt = promptFont.render("Choose your wheels (press a key)", True, (255, 255, 255))
            biggerWheel1 = pygame.transform.scale(wheel1, (wheel1.get_width() * 3, wheel1.get_height() * 3))
            biggerWheel2 = pygame.transform.scale(wheel2, (wheel2.get_width() * 3, wheel2.get_height() * 3))
            biggerWheel3 = pygame.transform.scale(wheel3, (wheel3.get_width() * 3, wheel3.get_height() * 3))
            biggerWheel4 = pygame.transform.scale(wheel4, (wheel4.get_width() * 3, wheel4.get_height() * 3))
            screen.blit(promptBorder, (130, 25))
            screen.blit(prompt, (promptX, promptY))
            screen.blit(biggerWheel1, (option1X, option1Y))
            screen.blit(option1Text, (option1X - 100, option1Y))
            screen.blit(biggerWheel2, (option2X, option2Y))
            screen.blit(option2Text, (option2X - 100, option2Y))
            screen.blit(biggerWheel3, (option3X, option3Y))
            screen.blit(option3Text, (option3X - 100, option3Y))
            screen.blit(biggerWheel4, (option4X, option4Y))
            screen.blit(option4Text, (option4X - 100, option4Y))
            for event in pygame.event.get():
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_1:
            ...
            backgroundDraw()
            prompt = promptFont.render("Radical!", True, (255, 255, 255))
            screen.blit(promptBorder, (130, 25))
            screen.blit(prompt, (promptX, promptY))
            screen.blit(body, (300, 150))
            if body == body1:
            ...
            backgroundDraw()
            prompt = promptFont.render("Choose your engine (press a key)", True, (255, 255, 255))
            screen.blit(promptBorder, (130, 25))
            screen.blit(prompt, (promptX, promptY))
            ...
            backgroundDraw()
            biggerDecal1 = pygame.transform.scale(decal1, (decal1.get_width() * 3, decal1.get_height() * 3))
            biggerDecal2 = pygame.transform.scale(decal2, (decal2.get_width() * 3, decal2.get_height() * 3))
            biggerDecal3 = pygame.transform.scale(decal3, (decal3.get_width() * 3, decal3.get_height() * 3))
            biggerDecal4 = pygame.transform.scale(decal4, (decal4.get_width() * 3, decal4.get_height() * 3))
            prompt = promptFont.render("Choose your decal (press a key)", True, (255, 255, 255))
            screen.blit(promptBorder, (130, 25))
            screen.blit(prompt, (promptX, promptY))
            screen.blit(biggerDecal1, (option1X, option1Y))
            screen.blit(option1Text, (option1X - 100, option1Y))
            screen.blit(biggerDecal2, (option2X, option2Y))
            screen.blit(option2Text, (option2X - 100, option2Y))
            screen.blit(biggerDecal3, (option3X, option3Y))
            screen.blit(option3Text, (option3X - 100, option3Y))
            screen.blit(biggerDecal4, (option4X, option4Y))
            screen.blit(option4Text, (option4X - 100, option4Y))
            for event in pygame.event.get():
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_1:
            ...
            scoreText1 = font.render("Speed: " + str(speed) + "/80", True, (255, 255, 255))
            scoreText2 =  font.render("Design: " + str(design) + "/80", True, (255, 255, 255))
            screen.blit(promptBorder, (130, 25))
            screen.blit(prompt, (promptX, promptY))
            screen.blit(body, (300, 150))
            if body == body1:
            ...
            screen.blit(scoreBox, (350, 500))
            screen.blit(scoreText1, (360, 500))
            screen.blit(scoreText2, (360, 550))
            if event.type == pygame.MOUSEBUTTONDOWN:
                mousePosition = pygame.mouse.get_pos()
            ...
            while onDriveScreen:
                print(speed)
                clock.tick(60)/100000
                timer += 1
                backgroundDraw()
                prompt = promptFont.render("Adios! Drive safely and sober.", True, (255, 255, 255))
                screen.blit(promptBorder, (130, 25))
                screen.blit(prompt, (promptX, promptY))
                #move car
                if body == body1:
